...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("sporbbpuzzle", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("sporbbpuzzle", null, 384, 384);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "sporbbpuzzle";
		app.meta["name"] = "sporbbpuzzle";
		...
		#elseif air
		app.window.title = "sporbbpuzzle";
		#else
		app.window.context.attributes.background = 0;
		app.window.frameRate = 12;
		#end
